...
check "no TODO/FIXME in src/"       "! grep -rniE 'TODO|FIXME|XXX' src"
check "no customer-internal names"  "! grep -rniE '(daimler|toennies|tönnies)' src tests examples config README.md"
